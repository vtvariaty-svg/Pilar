    ...
    <TenantAdminRoute>
      <AdminLayout>
        <div className="mb-6">
          ...
          <p className="mt-1 text-sm text-neutral-500">Informações gerais da plataforma</p>
        </div>
        ...
        <form onSubmit={handleSave} className="max-w-xl">
          <div className="rounded-2xl border border-neutral-200 bg-white p-6">
            <div className="flex flex-col gap-4">
              ...
              <Field label="Região de atendimento" value={form.serviceRegion} onChange={(v) => patch({ serviceRegion: v })} />
              ...
              <Field label="Anos de experiência" value={form.yearsExperience} onChange={(v) => patch({ yearsExperience: v })} />
              <Field label="Horário de atendimento" value={form.businessHours} onChange={(v) => patch({ businessHours: v })} />
              <div>
